const page_change_monitor = 'page_change_monitor';
...
function monitorURLChanges(){
    let has_changed = hasPageUrlChanged(page_change_monitor,window.location.href);
    if(has_changed === true) {
//do some stuff
      console.log('has changed',window.location.href);
    }
//     else console.log('no change',window.location.href);
}

setURLchangeMonkeyPatch(page_change_monitor);
