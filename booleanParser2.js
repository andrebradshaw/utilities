...
let test_data = permutateNear(`("bcba" OR "lba" OR "babc")~14(therap OR consult OR analyst)~work`)
...
/*NOTE: This is duplicate efforts and wasting compute power. Really need to splice the arr instead of filtering it, but that will require a recursive function, and fuck that noise -- for now */
}
