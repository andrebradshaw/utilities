function createUploadForm(){
    ...
    function createDraggableResizableContainer(edit) {
      ...
      function createTextInputForm(ref,style_obj){
        ...
        a(text,[['placeholder','Copy and paste your ENTIRE column into this field.']])
        ...
        btn.onclick = convertMillsec2yrs;
      }

    let cont_obj = {
        main_cont_id: 'time_conversion_container',
        head_bg_color: '#1a1a1a',
        cbod_bg_color: '#2b2b2b',
        head_text_color: '#f2f2f2',
        head_text: 'time conversion',
...
function convertMillsec2yrs(){
/*THIS DOES NOT HANDLE A TABLE> ONLY A COLUMN*/
    const transposeTable = (a)=>  a[0].map((_, c)=> a.map(r=> r[c]));
